...
public class CustomerOrderResource {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Order is created Successfully"),
	...
	@PostMapping ("/orders")
	public OrderPlacedDTO addOrder (@RequestHeader (value="userId" , required = true) Long userId,@RequestBody CustomerOrderDTO order) {
		if(userId != null && userSservice.isUserExist(userId)) {
			if(storeService.isStoreExist(order.getStoreId())) {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OrderList retrieved Successfully by storeID"),
            @ApiResponse(code = 400, message = "Input JSON is wrong"),
            @ApiResponse(code =401 , message = "User is Not authorized for this operation"),
            @ApiResponse(code = 412, message = "Validation failed Order Data."),
            @ApiResponse(code = 500, message = "Internal server error")
	...
	public List<CustomerOrderDetailDTO> getOrdersByStoreId(@RequestHeader(value="userId") Long userId , @PathVariable ("storeId") Long storeId){
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OrderList retrieved Successfully by userID"),
            @ApiResponse(code = 400, message = "Input JSON is wrong"),
            @ApiResponse(code =401 , message = "User is Not authorized for this operation"),
            @ApiResponse(code = 412, message = "Validation failed Order Data."),
            @ApiResponse(code = 500, message = "Internal server error")
	...
	public List<CustomerOrderDetailDTO> getOrdersByUserId(@PathVariable ("userId") Long userId){
		if(userId != null) {
			return customerOrderService.getOrdersByOrderBy(userId);
		}
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OrderList retrieved Successfully by orderID"),
            @ApiResponse(code = 400, message = "Input JSON is wrong"),
            @ApiResponse(code =401 , message = "User is Not authorized for this operation"),
            @ApiResponse(code = 412, message = "Validation failed Order Data."),
            @ApiResponse(code = 500, message = "Internal server error")
	...
	public CustomerOrderDetailDTO getOrdersByOrderId(@RequestHeader(value="userId", required=true) Long userId ,@PathVariable ("orderId") Long orderId){
	...
	public ResponseEntity<Void> deleteUserOrders(@RequestHeader(value="userId") Long userId , @PathVariable ("orderId") Long orderId) {
		if(userId!=null && orderId!=null) {
